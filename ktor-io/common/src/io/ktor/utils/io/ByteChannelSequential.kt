...
public abstract class ByteChannelSequentialBase(
    ...
    override val isClosedForRead: Boolean
        get() = isCancelled || (closed && availableForRead == 0)
    ...
    final override val closedCause: Throwable? get() = _closed.value?.cause
    ...
    override fun close(cause: Throwable?): Boolean {
        val closeElement = if (cause == null) CloseElement(null) else CloseElement(cause)
